...
/* We do not support C11 <threads.h>.  */
      ...
      real, dimension(ib:ie,jb:je,kb:ke) :: pi0,prs0,rho0,thv0,th0,qv0
      ...
      real, dimension(ib:ie,jb:je,kb:ke) :: tha,th3d,thten,thten1,thterm
...
! initialize CCN concentrations as constant mixing ratios througout the domain
      ...
      do j=jbm,jem
      do i=ibm,iem
       qa (i,j,k,lccn-1) = ccn/rho0(i,j,1)
       q3d(i,j,k,lccn-1) = ccn/rho0(i,j,1)
      enddo
      enddo
      enddo
    ENDIF
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      subroutine getset(gz,sigma,sigmaf,rmh,mf,dzdx,dzdy,                  &
      ...
      real, intent(inout), dimension(ib:ie,jb:je) :: ust,u1,v1,w1
