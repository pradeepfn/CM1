...
!
! Current version is tagged as V3.4
...
! HM add reflectivity      
   ...
   real, dimension(nk) :: PRE,PCC,FR,FI,FC,FS,FG
   real :: tem1,tem2
   real*8, dimension(nj) :: bud1,bud2,bud3,bud4
...
!$omp W1D,WVAR1D,PRE,PCC,dBZ,PRECPRT1D,SNOWRT1D,EFFC1D,EFFI1D,EFFS1D,EFFR1D,  &
...
! ADD SEDIMENTATION TENDENCIES
                                  QGSTEN,QRSTEN,QISTEN,QNISTEN,QCSTEN,   &
                                  PRE,PCC,FR,FI,FC,FS,FG,eqtset,radopt,tsmall,effis1d)
...
!CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      SUBROUTINE M2005MICRO_GRAUPEL(QC3DTEN,QI3DTEN,QNI3DTEN,QR3DTEN,NC3DTEN,    &
       ...
       EFFC,EFFI,EFFS,EFFR,DT,                                                   &
                        ...
                        PRE,PCC,FR,FI,FC,FS,FG,eqtset,radopt,tsmall,effis)
...
! DUMMY VARIABLES
     ...
     REAL DUMMQS,DUMQG,SAVEQC,SAVET,RDT
